...
<c:forEach items="${itemList }" var="cartDetails">
	...
	<c:choose>
		...
		<td><span>&yen;<span class="currPrice">${cartDetails.currprice }</span></span></td>
		<td>
		...
		<td>
			<a href="javascript:delCartitem(${cartDetails.cartitemid })">删除</a>
		</td>
	</tr>
</c:forEach>
